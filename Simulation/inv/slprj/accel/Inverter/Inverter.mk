...
MODEL              = Inverter
MODULES            = Inverter_acc.c Inverter_acc_data.c
MAKEFILE           = Inverter.mk
MATLAB_ROOT        = C:/Program Files/MATLAB/R2018a
ALT_MATLAB_ROOT    = C:/PROGRA~1/MATLAB/R2018a
MASTER_ANCHOR_DIR  = 
START_DIR          = D:/GitHub Repositories/IMMD
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/Inverter \
	-I$(START_DIR)/Project/3501/Furkan/Inverter Model with Parasitics \
