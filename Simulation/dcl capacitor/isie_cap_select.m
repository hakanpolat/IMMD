...
performances(:,1) = 1./performances(:,1);

performance_actual(:,1) = (performances(:,1)/max(performances(:,1)));
performance_actual(:,2) = (performances(:,2)/max(performances(:,2)));
performance_actual(:,3) = (performances(:,3)/max(performances(:,3)));
performance_actual(:,4) = (performances(:,4)/max(performances(:,4)));

weight_pd = 0.2;
weight_h = 0.2;
weight_t = 0.2;
weight_c = 0.4;
overall_cost = performance_actual(:,1)*weight_pd + ...
    performance_actual(:,2)*weight_c + ...
    performance_actual(:,3)*weight_h + ...
    performance_actual(:,4)*weight_t;

weight_pd = 0.4;
weight_h = 0.2;
weight_t = 0.2;
weight_c = 0.2;
overall_powerdensity = performance_actual(:,1)*weight_pd + ...
    performance_actual(:,2)*weight_c + ...
    performance_actual(:,3)*weight_h + ...
    performance_actual(:,4)*weight_t;
...
weight_t = 0.4;
weight_c = 0.2;
overall_temperature = performance_actual(:,1)*weight_pd + ...
    performance_actual(:,2)*weight_c + ...
    performance_actual(:,3)*weight_h + ...
    performance_actual(:,4)*weight_t;
...
weight_t = 0.2;
weight_c = 0.2;
overall_height = performance_actual(:,1)*weight_pd + ...
    performance_actual(:,2)*weight_c + ...
    performance_actual(:,3)*weight_h + ...
    performance_actual(:,4)*weight_t;

overall(:,1) = overall_powerdensity;
overall(:,2) = overall_cost;
overall(:,3) = overall_height;
overall(:,4) = overall_temperature;
