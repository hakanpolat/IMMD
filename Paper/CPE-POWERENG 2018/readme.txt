...
Authors must adhere to the IEEE Conference written paper format. The author must submit the full paper for review before the due submission deadline . These are submitted through the IES Submit system, which is entered from the conference website. IEEE is strict about the requirements for PDF files for inclusion in the IEEE Xplore® Digital Library.
