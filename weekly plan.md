...
* GaN ile ilgili literatür özeti için bkz: [Literatür GaN](https://drive.google.com/drive/u/0/folders/1ubTMRptHmwLgJ4jDNLTa7g9dLolP0Rbb)
* Education makalesi taslak planı yapıldı.
...
#### Gerçekleşen çalışmalar:
* PEMD abstract yüklendi (multi-physics optimization).
* Maxwell simulasyonları yapıldı (8 kW PMSM, 4 modül).
...
#### Planlanan çalışmalar:
* BAP için tool: no progress
* RPG makale: no progress
* GRW-2017 poster submit: OK

#### Gerçekleşen çalışmalar:
* GRW-2017 poster conclusion hariç bitirildi.
