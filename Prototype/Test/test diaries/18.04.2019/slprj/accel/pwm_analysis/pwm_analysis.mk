...
MODEL              = pwm_analysis
MODULES            = pwm_analysis_acc.c pwm_analysis_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE           = pwm_analysis.mk
MATLAB_ROOT        = C:/Program Files/MATLAB/R2018a
ALT_MATLAB_ROOT    = C:/PROGRA~1/MATLAB/R2018a
MASTER_ANCHOR_DIR  = 
START_DIR          = D:/GitHub Repositories/IMMD/Prototype/Test/test diaries/18.04.2019
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/pwm_analysis \
