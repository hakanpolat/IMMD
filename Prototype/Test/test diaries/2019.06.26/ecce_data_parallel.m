...
figure;
hold all;
plot(time_noint_200v_200khz*1e3,Idcm1sh1_noint_200v_200khz-mean(Idcm1sh1_noint_200v_200khz),'r-','Linewidth',1);
plot(time_noint_200v_200khz*1e3,Idcm2sh3_noint_200v_200khz-mean(Idcm2sh3_noint_200v_200khz),'b-','Linewidth',1);
%plot(time_yesint_200v_725khz*1e3,Vdc_yesint_200v_725khz,'g-','Linewidth',1);
%plot(time_yesint_200v_200khz*1e3,Vdc_yesint_200v_200khz,'b-','Linewidth',1);
set(gca,'FontSize',14);
xlabel('Time (ms)','FontSize',14,'FontWeight','Bold');
...
% figure;
% hold all;
% %plot(time_noint_200v_725khz*1e3,Vdc_noint_200v_725khz,'b-','Linewidth',1);
% %plot(time_noint_200v_200khz*1e3,Vdc_noint_200v_200khz,'r-','Linewidth',1);
% plot(time_noint_200v_725khz*1e3,Idcm1cp1_noint_200v_725khz,'b-','Linewidth',1);
