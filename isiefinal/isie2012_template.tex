...
\begin{figure}[h]
  \centering
  \includegraphics[width=9cm]{immd_examples}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=9cm]{volume_cost}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=9cm]{dclink_model}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=9cm]{interleave}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=9cm]{rms_current}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=9cm]{algorithm}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=9cm]{rms_vs_ma}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=9cm]{cap_vs_fsw}
