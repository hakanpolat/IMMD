...
void Gpio_select(void)
{
	...
	GpioCtrlRegs.GPADIR.all = 0x00000A04;
...
void Setup_ePWM1(void)
{
    ...
    EPwm1Regs.TBPRD = 1875; // 18750 Cycle will be counted
    EPwm1Regs.AQCTLA.all = 0x0060; // Up = set; Down = clear
    EPwm1Regs.AQCTLB.all = 0x0090; // Up = clear; Down = set
    EPwm1Regs.CMPA.half.CMPA = EPwm1Regs.TBPRD/2;
    EPwm1Regs.DBCTL.bit.IN_MODE = 0;
    EPwm1Regs.DBCTL.bit.OUT_MODE = 3;
    EPwm1Regs.DBCTL.bit.POLSEL = 2;
    EPwm1Regs.DBRED = 1875/50;
    EPwm1Regs.DBFED = 1875/50;
}
//===========================================================================
// End of SourceCode.
//===========================================================================
