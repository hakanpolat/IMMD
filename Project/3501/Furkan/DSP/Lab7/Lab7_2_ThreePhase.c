...
{
	EALLOW;
	GpioCtrlRegs.GPAMUX1.all = 0x00000111;	// GPIO15 ... GPIO0 = General Puropse I/O
...
{   // PWM 1
    ...
    // PWM 2
    EPwm2Regs.TBCTL.bit.CLKDIV = 2; //010 -> /4
    EPwm2Regs.TBCTL.bit.HSPCLKDIV = 5; // 101 -> /10
    EPwm2Regs.TBCTL.bit.CTRMODE = 2; // both up and down counting
    EPwm2Regs.TBCTL.bit.PHSEN = 1; // Phase Enabled
    EPwm2Regs.TBCTL.bit.SYNCOSEL = 0; // SYNCO = SYNCI
    EPwm2Regs.TBPRD = 1875; // 1875 Cycle will be counted
    EPwm2Regs.AQCTLA.all = 0x0006; // zero = set; period = clear
    EPwm2Regs.TBPHS.half.TBPHS = 1875/3; // Add 120 degree phase
    // PWM 3
    EPwm3Regs.TBCTL.bit.CLKDIV = 2; //010 -> /4
    EPwm3Regs.TBCTL.bit.HSPCLKDIV = 5; // 101 -> /10
    EPwm3Regs.TBCTL.bit.CTRMODE = 2; // both up and down counting
    EPwm3Regs.TBCTL.bit.PHSEN = 1; // Phase Enabled
    EPwm3Regs.TBCTL.bit.SYNCOSEL = 0; // SYNCO = SYNCI
    EPwm3Regs.TBPRD = 1875; // 1875 Cycle will be counted
    EPwm3Regs.AQCTLA.all = 0x0006; // zero = set; period = clear
    EPwm3Regs.TBPHS.half.TBPHS = 2*1875/3; // Add 240 degree phase
}
//===========================================================================
// End of SourceCode.
//===========================================================================
