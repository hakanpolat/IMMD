...
#ifndef RTW_HEADER_InverterModulesInParallel_acc_private_h_
#define RTW_HEADER_InverterModulesInParallel_acc_private_h_
#include "rtwtypes.h"
...
; real_T InverterModulesInParallel_acc_rt_TDelayInterpolate ( real_T
