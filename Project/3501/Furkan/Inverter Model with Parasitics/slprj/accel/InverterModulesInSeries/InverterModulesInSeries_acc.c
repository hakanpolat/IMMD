...
( _rtB -> B_20_14_0 > InverterModulesInSeries_rtC ( S ) -> B_20_15_0 ) ; } if
( _rtDW -> Compare_Mode ) { _rtB -> B_20_18_0 = _rtB -> B_20_3_0 ; } else {
_rtB -> B_20_18_0 = _rtB -> B_20_17_0 ; } } isHit = ssIsSampleHit ( S , 2 , 0
) ; if ( isHit != 0 ) { _rtB -> B_20_19_0 = _rtDW -> DelayInput2_DSTATE ; }
...
B_20_14_0 < InverterModulesInSeries_rtC ( S ) -> B_20_31_0 ) ; } if ( _rtDW
...
B_20_57_0 > InverterModulesInSeries_rtC ( S ) -> B_20_58_0 ) ; } if ( _rtDW
...
B_20_57_0 < InverterModulesInSeries_rtC ( S ) -> B_20_74_0 ) ; } if ( _rtDW
...
InverterModulesInSeries_rtC ( S ) -> B_20_91_0 ) ; } if ( _rtDW ->
...
B_20_90_0 < InverterModulesInSeries_rtC ( S ) -> B_20_106_0 ) ; } if ( _rtDW
-> Compare_Mode_j ) { _rtB -> B_20_108_0 = _rtB -> B_20_3_0 ; } else { _rtB
-> B_20_108_0 = _rtB -> B_20_17_0 ; } } isHit = ssIsSampleHit ( S , 2 , 0 ) ;
if ( isHit != 0 ) { _rtB -> B_20_109_0 = _rtDW -> DelayInput2_DSTATE_f ; }
...
InverterModulesInSeries_rtC ( S ) -> B_20_123_0 ) ; } if ( _rtDW ->
...
B_20_122_0 < InverterModulesInSeries_rtC ( S ) -> B_20_138_0 ) ; } if ( _rtDW
-> Compare_Mode_iz ) { _rtB -> B_20_140_0 = _rtB -> B_20_3_0 ; } else { _rtB
-> B_20_140_0 = _rtB -> B_20_17_0 ; } } isHit = ssIsSampleHit ( S , 2 , 0 ) ;
if ( isHit != 0 ) { _rtB -> B_20_141_0 = _rtDW -> DelayInput2_DSTATE_m ; }
...
InverterModulesInSeries_rtC ( S ) -> B_20_155_0 ) ; } if ( _rtDW ->
...
B_20_154_0 < InverterModulesInSeries_rtC ( S ) -> B_20_170_0 ) ; } if ( _rtDW
-> Compare_Mode_c ) { _rtB -> B_20_172_0 = _rtB -> B_20_46_0 ; } else { _rtB
-> B_20_172_0 = _rtB -> B_20_60_0 ; } } isHit = ssIsSampleHit ( S , 2 , 0 ) ;
if ( isHit != 0 ) { _rtB -> B_20_173_0 = _rtDW -> DelayInput2_DSTATE_dj ; }
...
InverterModulesInSeries_rtC ( S ) -> B_20_187_0 ) ; } if ( _rtDW ->
...
B_20_186_0 < InverterModulesInSeries_rtC ( S ) -> B_20_202_0 ) ; } if ( _rtDW
-> Compare_Mode_o ) { _rtB -> B_20_204_0 = _rtB -> B_20_46_0 ; } else { _rtB
-> B_20_204_0 = _rtB -> B_20_60_0 ; } } isHit = ssIsSampleHit ( S , 2 , 0 ) ;
if ( isHit != 0 ) { _rtB -> B_20_205_0 = _rtDW -> DelayInput2_DSTATE_nv ; }
...
_rtB -> B_19_7_0 > _rtP -> P_50 ? 0 : - 1 ; } _rtB -> B_19_9_0 = _rtDW ->
Saturationtoavoidnegativesqrt_MODE == 1 ? _rtP -> P_49 : _rtDW ->
Saturationtoavoidnegativesqrt_MODE == - 1 ? _rtP -> P_50 : _rtB -> B_19_7_0 ;
if ( ssIsMajorTimeStep ( S ) != 0 ) { if ( _rtDW -> Sqrt_DWORK1 != 0 ) {
ssSetBlockStateForSolverChangedAtMajorStep ( S ) ; _rtDW -> Sqrt_DWORK1 = 0 ;
} _rtB -> B_19_10_0 = muDoubleScalarSqrt ( _rtB -> B_19_9_0 ) ; srUpdateBC (
_rtDW -> TrueRMS_SubsysRanBC ) ; } else { if ( _rtB -> B_19_9_0 < 0.0 ) {
_rtB -> B_19_10_0 = - muDoubleScalarSqrt ( muDoubleScalarAbs ( _rtB ->
B_19_9_0 ) ) ; } else { _rtB -> B_19_10_0 = muDoubleScalarSqrt ( _rtB ->
B_19_9_0 ) ; } if ( _rtB -> B_19_9_0 < 0.0 ) { _rtDW -> Sqrt_DWORK1 = 1 ; } }
} isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( ( isHit != 0 ) && (
ssIsMajorTimeStep ( S ) != 0 ) ) { if ( _rtB -> B_20_219_0 ) { if ( ! _rtDW
-> RMS_MODE ) { if ( ssGetTaskTime ( S , 1 ) != ssGetTStart ( S ) ) {
ssSetBlockStateForSolverChangedAtMajorStep ( S ) ; } ( void ) memset ( & ( (
( XDis_InverterModulesInSeries_T * ) ssGetContStateDisabled ( S ) ) ->
integrator_CSTATE_i ) , 0 , 2 * sizeof ( boolean_T ) ) ; _rtDW -> RMS_MODE =
true ; } } else { if ( _rtDW -> RMS_MODE ) {
ssSetBlockStateForSolverChangedAtMajorStep ( S ) ; ( void ) memset ( & ( ( (
XDis_InverterModulesInSeries_T * ) ssGetContStateDisabled ( S ) ) ->
integrator_CSTATE_i ) , 1 , 2 * sizeof ( boolean_T ) ) ; _rtDW -> RMS_MODE =
false ; } } } if ( _rtDW -> RMS_MODE ) { _rtB -> B_17_0_0 = _rtX ->
...
ssGetT ( S ) ; real_T tMinusDelay = simTime - _rtP -> P_24 ; _rtB -> B_17_1_0
= InverterModulesInSeries_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , *
...
Tail , _rtDW -> TransportDelay_IWORK_e . Head , _rtP -> P_25 , 0 , (
boolean_T ) ( ssIsMinorTimeStep ( S ) && ( ssGetTimeOfLastOutput ( S ) ==
ssGetT ( S ) ) ) ) ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0
) { _rtB -> B_17_3_0 = _rtP -> P_26 ; } rtb_B_20_21_0 = ( ssGetT ( S ) >=
_rtB -> B_17_3_0 ) ; isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 )
{ _rtB -> B_17_5_0 = _rtDW -> Memory_PreviousInput_j ; } if ( rtb_B_20_21_0 )
{ _rtB -> B_16_0_0 = _rtB -> B_17_0_0 - _rtB -> B_17_1_0 ; _rtB -> B_16_1_0 =
_rtP -> P_21 * _rtB -> B_16_0_0 ; _rtB -> B_17_7_0 = _rtB -> B_16_1_0 ; }
else { _rtB -> B_17_7_0 = _rtB -> B_17_5_0 ; } _rtB -> B_17_8_0 = _rtX ->
...
ssGetT ( S ) ; real_T tMinusDelay = simTime - _rtP -> P_29 ; _rtB -> B_17_9_0
= InverterModulesInSeries_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , *
...
Tail , _rtDW -> TransportDelay_IWORK_p . Head , _rtP -> P_30 , 0 , (
boolean_T ) ( ssIsMinorTimeStep ( S ) && ( ssGetTimeOfLastOutput ( S ) ==
ssGetT ( S ) ) ) ) ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0
) { _rtB -> B_17_11_0 = _rtP -> P_31 ; } rtb_B_20_21_0 = ( ssGetT ( S ) >=
_rtB -> B_17_11_0 ) ; isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 )
{ _rtB -> B_17_13_0 = _rtDW -> Memory_PreviousInput_n ; } if ( rtb_B_20_21_0
) { _rtB -> B_15_0_0 = _rtB -> B_17_8_0 - _rtB -> B_17_9_0 ; _rtB -> B_15_1_0
= _rtP -> P_20 * _rtB -> B_15_0_0 ; _rtB -> B_17_15_0 = _rtB -> B_15_1_0 ; }
else { _rtB -> B_17_15_0 = _rtB -> B_17_13_0 ; } _rtB -> B_17_16_0 . re =
_rtB -> B_17_7_0 ; _rtB -> B_17_16_0 . im = _rtB -> B_17_15_0 ; _rtB ->
B_17_19_0 = ( muDoubleScalarSin ( _rtP -> P_35 * ssGetTaskTime ( S , 0 ) +
_rtP -> P_36 ) * _rtP -> P_33 + _rtP -> P_34 ) * _rtB -> B_20_215_0 [ 4 ] ;
_rtB -> B_17_21_0 = ( muDoubleScalarSin ( _rtP -> P_39 * ssGetTaskTime ( S ,
0 ) + _rtP -> P_40 ) * _rtP -> P_37 + _rtP -> P_38 ) * _rtB -> B_20_215_0 [ 4
] ; _rtB -> B_17_22_0 = _rtP -> P_41 * muDoubleScalarHypot ( _rtB ->
B_17_16_0 . re , _rtB -> B_17_16_0 . im ) ; if ( ssIsMajorTimeStep ( S ) != 0
) { srUpdateBC ( _rtDW -> RMS_SubsysRanBC ) ; } } if ( _rtB -> B_20_217_0 ) {
_rtB -> B_20_221_0 = _rtB -> B_19_10_0 ; } else { _rtB -> B_20_221_0 = _rtB
-> B_17_22_0 ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { {
if ( ( _rtDW -> HiddenToAsyncQueue_InsertedFor_RMS1_at_outport_0_PWORK .
AQHandles || _rtDW -> HiddenToAsyncQueue_InsertedFor_RMS1_at_outport_0_PWORK
. SlioLTF ) && ssGetLogOutput ( S ) ) { sdiSlioSdiWriteSignal ( _rtDW ->
HiddenToAsyncQueue_InsertedFor_RMS1_at_outport_0_PWORK . AQHandles , _rtDW ->
HiddenToAsyncQueue_InsertedFor_RMS1_at_outport_0_PWORK . SlioLTF , 0 ,
ssGetTaskTime ( S , 1 ) , ( void * ) & _rtB -> B_20_221_0 ) ; } } } isHit =
ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) { if ( _rtB -> B_20_215_0 [
25 ] > _rtP -> P_157 ) { _rtB -> B_20_223_0 = _rtP -> P_157 ; } else if (
_rtB -> B_20_215_0 [ 25 ] < _rtP -> P_158 ) { _rtB -> B_20_223_0 = _rtP ->
P_158 ; } else { _rtB -> B_20_223_0 = _rtB -> B_20_215_0 [ 25 ] ; } if ( _rtB
-> B_20_215_0 [ 23 ] > _rtP -> P_159 ) { _rtB -> B_20_224_0 = _rtP -> P_159 ;
} else if ( _rtB -> B_20_215_0 [ 23 ] < _rtP -> P_160 ) { _rtB -> B_20_224_0
= _rtP -> P_160 ; } else { _rtB -> B_20_224_0 = _rtB -> B_20_215_0 [ 23 ] ; }
if ( _rtB -> B_20_215_0 [ 24 ] > _rtP -> P_161 ) { _rtB -> B_20_225_0 = _rtP
-> P_161 ; } else if ( _rtB -> B_20_215_0 [ 24 ] < _rtP -> P_162 ) { _rtB ->
B_20_225_0 = _rtP -> P_162 ; } else { _rtB -> B_20_225_0 = _rtB -> B_20_215_0
[ 24 ] ; } if ( _rtB -> B_20_215_0 [ 51 ] > _rtP -> P_163 ) { _rtB ->
B_20_226_0 = _rtP -> P_163 ; } else if ( _rtB -> B_20_215_0 [ 51 ] < _rtP ->
P_164 ) { _rtB -> B_20_226_0 = _rtP -> P_164 ; } else { _rtB -> B_20_226_0 =
_rtB -> B_20_215_0 [ 51 ] ; } if ( _rtB -> B_20_215_0 [ 49 ] > _rtP -> P_165
) { _rtB -> B_20_227_0 = _rtP -> P_165 ; } else if ( _rtB -> B_20_215_0 [ 49
] < _rtP -> P_166 ) { _rtB -> B_20_227_0 = _rtP -> P_166 ; } else { _rtB ->
B_20_227_0 = _rtB -> B_20_215_0 [ 49 ] ; } if ( _rtB -> B_20_215_0 [ 50 ] >
_rtP -> P_167 ) { _rtB -> B_20_228_0 = _rtP -> P_167 ; } else if ( _rtB ->
B_20_215_0 [ 50 ] < _rtP -> P_168 ) { _rtB -> B_20_228_0 = _rtP -> P_168 ; }
else { _rtB -> B_20_228_0 = _rtB -> B_20_215_0 [ 50 ] ; } ssCallAccelRunBlock
( S , 20 , 229 , SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 20 , 230 ,
SS_CALL_MDL_OUTPUTS ) ; if ( _rtB -> B_20_215_0 [ 26 ] > _rtP -> P_169 ) {
_rtB -> B_20_231_0 = _rtP -> P_169 ; } else if ( _rtB -> B_20_215_0 [ 26 ] <
_rtP -> P_170 ) { _rtB -> B_20_231_0 = _rtP -> P_170 ; } else { _rtB ->
B_20_231_0 = _rtB -> B_20_215_0 [ 26 ] ; } if ( _rtB -> B_20_215_0 [ 52 ] >
_rtP -> P_171 ) { _rtB -> B_20_232_0 = _rtP -> P_171 ; } else if ( _rtB ->
B_20_215_0 [ 52 ] < _rtP -> P_172 ) { _rtB -> B_20_232_0 = _rtP -> P_172 ; }
else { _rtB -> B_20_232_0 = _rtB -> B_20_215_0 [ 52 ] ; } ssCallAccelRunBlock
( S , 20 , 233 , SS_CALL_MDL_OUTPUTS ) ; } ssCallAccelRunBlock ( S , 20 , 300
, SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 20 , 502 ,
SS_CALL_MDL_OUTPUTS ) ; isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( ( isHit !=
0 ) && ( ssIsMajorTimeStep ( S ) != 0 ) ) { if ( _rtB -> B_20_640_0 ) { if (
! _rtDW -> RMS_MODE_h ) { if ( ssGetTaskTime ( S , 1 ) != ssGetTStart ( S ) )
{ ssSetBlockStateForSolverChangedAtMajorStep ( S ) ; } ( void ) memset ( & (
( ( XDis_InverterModulesInSeries_T * ) ssGetContStateDisabled ( S ) ) ->
...
= false ; } } } if ( _rtDW -> RMS_MODE_h ) { rtb_B_20_200_0 =
muDoubleScalarSin ( _rtP -> P_5 * ssGetTaskTime ( S , 0 ) + _rtP -> P_6 ) *
_rtP -> P_3 + _rtP -> P_4 ; _rtB -> B_12_3_0 [ 0 ] = _rtB -> B_20_215_0 [ 3 ]
* rtb_B_20_200_0 ; _rtB -> B_12_3_0 [ 1 ] = _rtB -> B_20_215_0 [ 1 ] *
rtb_B_20_200_0 ; _rtB -> B_12_3_0 [ 2 ] = _rtB -> B_20_215_0 [ 2 ] *
rtb_B_20_200_0 ; rtb_B_20_200_0 = muDoubleScalarSin ( _rtP -> P_9 *
ssGetTaskTime ( S , 0 ) + _rtP -> P_10 ) * _rtP -> P_7 + _rtP -> P_8 ; _rtB
-> B_12_5_0 [ 0 ] = _rtB -> B_20_215_0 [ 3 ] * rtb_B_20_200_0 ; _rtB ->
B_12_5_0 [ 1 ] = _rtB -> B_20_215_0 [ 1 ] * rtb_B_20_200_0 ; _rtB -> B_12_5_0
[ 2 ] = _rtB -> B_20_215_0 [ 2 ] * rtb_B_20_200_0 ; if ( ssIsMajorTimeStep (
S ) != 0 ) { srUpdateBC ( _rtDW -> RMS_SubsysRanBC_n ) ; } } isHit =
ssIsSampleHit ( S , 1 , 0 ) ; if ( ( isHit != 0 ) && ( ssIsMajorTimeStep ( S
) != 0 ) ) { if ( _rtB -> B_20_639_0 ) { if ( ! _rtDW -> TrueRMS_MODE_e ) {
...
_rtB -> B_20_215_0 [ 3 ] * _rtB -> B_20_215_0 [ 3 ] ; _rtB -> B_14_8_0 [ 1 ]
= _rtB -> B_20_215_0 [ 1 ] * _rtB -> B_20_215_0 [ 1 ] ; _rtB -> B_14_8_0 [ 2
...
_rtDW -> TrueRMS_SubsysRanBC_i ) ; } } isHit = ssIsSampleHit ( S , 2 , 0 ) ;
if ( isHit != 0 ) { ssCallAccelRunBlock ( S , 20 , 659 , SS_CALL_MDL_OUTPUTS
...
_ssGetModelBlockIO ( S ) ) ; _rtB -> B_20_0_0 = _rtP -> P_51 ; _rtB ->
B_20_3_0 = _rtP -> P_53 ; _rtB -> B_20_17_0 = _rtP -> P_65 ; _rtB ->
B_20_22_0 = _rtP -> P_67 ; _rtB -> B_20_28_0 = _rtP -> P_68 ; _rtB ->
B_20_37_0 = _rtP -> P_72 ; _rtB -> B_20_43_0 = _rtP -> P_73 ; _rtB ->
B_20_46_0 = _rtP -> P_75 ; _rtB -> B_20_60_0 = _rtP -> P_87 ; _rtB ->
...
214 , SS_CALL_MDL_UPDATE ) ; } if ( _rtDW -> TrueRMS_MODE ) { { real_T * *
uBuffer = ( real_T * * ) & _rtDW -> TransportDelay_PWORK . TUbufferPtrs [ 0 ]
; real_T * * tBuffer = ( real_T * * ) & _rtDW -> TransportDelay_PWORK .
...
TransportDelay_IWORK . Last , simTime - _rtP -> P_45 , tBuffer , uBuffer , (
...
B_19_1_0 ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { _rtDW
-> Memory_PreviousInput = _rtB -> B_19_7_0 ; } } if ( _rtDW -> RMS_MODE ) { {
...
TransportDelay_IWORK_e . Last , simTime - _rtP -> P_24 , tBuffer , uBuffer ,
...
B_17_0_0 ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { _rtDW
-> Memory_PreviousInput_j = _rtB -> B_17_7_0 ; } { real_T * * uBuffer = (
...
TransportDelay_IWORK_p . Last , simTime - _rtP -> P_29 , tBuffer , uBuffer ,
...
B_17_8_0 ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { _rtDW
-> Memory_PreviousInput_n = _rtB -> B_17_15_0 ; } } if ( _rtDW ->
TrueRMS_MODE_e ) { { real_T * * uBuffer = ( real_T * * ) & _rtDW ->
TransportDelay_PWORK_b . TUbufferPtrs [ 0 ] ; real_T * * tBuffer = ( real_T *
* ) & _rtDW -> TransportDelay_PWORK_b . TUbufferPtrs [ 3 ] ; real_T simTime =
ssGetT ( S ) ; _rtDW -> TransportDelay_IWORK_g . Head [ 0 ] = ( ( _rtDW ->
...
Memory_PreviousInput_k [ 2 ] = _rtB -> B_14_7_0 [ 2 ] ; } } UNUSED_PARAMETER
( tid ) ; }
#define MDL_UPDATE
...
B_InverterModulesInSeries_T * ) _ssGetModelBlockIO ( S ) ) ; if ( _rtDW ->
TrueRMS_MODE ) { _rtXdot -> integrator_CSTATE = _rtB -> B_19_8_0 ; } else { (
( XDot_InverterModulesInSeries_T * ) ssGetdX ( S ) ) -> integrator_CSTATE =
0.0 ; } if ( _rtDW -> RMS_MODE ) { _rtXdot -> integrator_CSTATE_i = _rtB ->
B_17_19_0 ; _rtXdot -> integrator_CSTATE_e = _rtB -> B_17_21_0 ; } else { {
real_T * dx ; int_T i ; dx = & ( ( ( XDot_InverterModulesInSeries_T * )
ssGetdX ( S ) ) -> integrator_CSTATE_i ) ; for ( i = 0 ; i < 2 ; i ++ ) { dx
[ i ] = 0.0 ; } } } if ( _rtDW -> RMS_MODE_h ) { _rtXdot ->
integrator_CSTATE_a [ 0 ] = _rtB -> B_12_5_0 [ 0 ] ; _rtXdot ->
integrator_CSTATE_o [ 0 ] = _rtB -> B_12_3_0 [ 0 ] ; _rtXdot ->
...
int_T i ; dx = & ( ( ( XDot_InverterModulesInSeries_T * ) ssGetdX ( S ) ) ->
integrator_CSTATE_a [ 0 ] ) ; for ( i = 0 ; i < 6 ; i ++ ) { dx [ i ] = 0.0 ;
} } } if ( _rtDW -> TrueRMS_MODE_e ) { _rtXdot -> integrator_CSTATE_c [ 0 ] =
_rtB -> B_14_8_0 [ 0 ] ; _rtXdot -> integrator_CSTATE_c [ 1 ] = _rtB ->
B_14_8_0 [ 1 ] ; _rtXdot -> integrator_CSTATE_c [ 2 ] = _rtB -> B_14_8_0 [ 2
] ; } else { { real_T * dx ; int_T i ; dx = & ( ( (
XDot_InverterModulesInSeries_T * ) ssGetdX ( S ) ) -> integrator_CSTATE_c [ 0
] ) ; for ( i = 0 ; i < 3 ; i ++ ) { dx [ i ] = 0.0 ; } } } }
...
Compare_RelopInput_ZC = _rtB -> B_20_14_0 - InverterModulesInSeries_rtC ( S )
-> B_20_15_0 ; _rtZCSV -> Compare_RelopInput_ZC_e = _rtB -> B_20_14_0 -
InverterModulesInSeries_rtC ( S ) -> B_20_31_0 ; _rtZCSV ->
Compare_RelopInput_ZC_d = _rtB -> B_20_57_0 - InverterModulesInSeries_rtC ( S
) -> B_20_58_0 ; _rtZCSV -> Compare_RelopInput_ZC_a = _rtB -> B_20_57_0 -
InverterModulesInSeries_rtC ( S ) -> B_20_74_0 ; _rtZCSV ->
Compare_RelopInput_ZC_p = _rtB -> B_20_90_0 - InverterModulesInSeries_rtC ( S
) -> B_20_91_0 ; _rtZCSV -> Compare_RelopInput_ZC_av = _rtB -> B_20_90_0 -
InverterModulesInSeries_rtC ( S ) -> B_20_106_0 ; _rtZCSV ->
Compare_RelopInput_ZC_n = _rtB -> B_20_122_0 - InverterModulesInSeries_rtC (
S ) -> B_20_123_0 ; _rtZCSV -> Compare_RelopInput_ZC_j = _rtB -> B_20_122_0 -
InverterModulesInSeries_rtC ( S ) -> B_20_138_0 ; _rtZCSV ->
Compare_RelopInput_ZC_o = _rtB -> B_20_154_0 - InverterModulesInSeries_rtC (
S ) -> B_20_155_0 ; _rtZCSV -> Compare_RelopInput_ZC_i = _rtB -> B_20_154_0 -
InverterModulesInSeries_rtC ( S ) -> B_20_170_0 ; _rtZCSV ->
Compare_RelopInput_ZC_f = _rtB -> B_20_186_0 - InverterModulesInSeries_rtC (
S ) -> B_20_187_0 ; _rtZCSV -> Compare_RelopInput_ZC_pd = _rtB -> B_20_186_0
- InverterModulesInSeries_rtC ( S ) -> B_20_202_0 ; if ( _rtDW ->
TrueRMS_MODE ) { _rtZCSV -> Saturationtoavoidnegativesqrt_UprLim_ZC = _rtB ->
B_19_7_0 - _rtP -> P_49 ; _rtZCSV -> Saturationtoavoidnegativesqrt_LwrLim_ZC
= _rtB -> B_19_7_0 - _rtP -> P_50 ; } else { { real_T * zcsv = & ( ( (
ZCV_InverterModulesInSeries_T * ) ssGetSolverZcSignalVector ( S ) ) ->
Saturationtoavoidnegativesqrt_UprLim_ZC ) ; int_T i ; for ( i = 0 ; i < 2 ; i
++ ) { zcsv [ i ] = 0.0 ; } } } if ( _rtDW -> TrueRMS_MODE_e ) { _rtZCSV ->
...
< 6 ; i ++ ) { zcsv [ i ] = 0.0 ; } } } } static void mdlInitializeSizes (
SimStruct * S ) { ssSetChecksumVal ( S , 0 , 4229896018U ) ; ssSetChecksumVal
( S , 1 , 3883902296U ) ; ssSetChecksumVal ( S , 2 , 2175198176U ) ;
ssSetChecksumVal ( S , 3 , 2104731106U ) ; { mxArray * slVerStructMat = NULL
...
) ; ( ( P_InverterModulesInSeries_T * ) ssGetModelRtp ( S ) ) -> P_18 = rtInf
; ( ( P_InverterModulesInSeries_T * ) ssGetModelRtp ( S ) ) -> P_49 = rtInf ;
