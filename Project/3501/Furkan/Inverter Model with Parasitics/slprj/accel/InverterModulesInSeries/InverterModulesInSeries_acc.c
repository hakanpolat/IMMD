...
#include "InverterModulesInSeries_acc_private.h"
#include <stdio.h>
...
#endif
boolean_T InverterModulesInSeries_acc_rt_TDelayUpdateTailOrGrowBuf ( int_T *
...
return ( true ) ; } real_T InverterModulesInSeries_acc_rt_TDelayInterpolate (
...
X_RMS_InverterModulesInSeries_T * localX ) { localX -> integrator_CSTATE_oy [
0 ] = localP -> P_3 ; localDW -> Memory_PreviousInput [ 0 ] = localP -> P_7 ;
localX -> integrator_CSTATE_aa [ 0 ] = localP -> P_8 ; localDW ->
Memory_PreviousInput_m [ 0 ] = localP -> P_12 ; localB -> B_22_22_0 [ 0 ] =
localP -> P_2 ; localX -> integrator_CSTATE_oy [ 1 ] = localP -> P_3 ;
localDW -> Memory_PreviousInput [ 1 ] = localP -> P_7 ; localX ->
integrator_CSTATE_aa [ 1 ] = localP -> P_8 ; localDW ->
...
localP -> P_2 ; } void InverterModulesInSeries_RMS_Disable ( SimStruct * S ,
DW_RMS_InverterModulesInSeries_T * localDW ) { localDW -> RMS_MODE = false ;
} void InverterModulesInSeries_RMS ( SimStruct * S , boolean_T rtu_Enable ,
real_T rtu_In , const real_T rtu_In_k [ 2 ] , B_RMS_InverterModulesInSeries_T
* localB , DW_RMS_InverterModulesInSeries_T * localDW ,
P_RMS_InverterModulesInSeries_T * localP , X_RMS_InverterModulesInSeries_T *
localX , XDis_RMS_InverterModulesInSeries_T * localXdis ) { boolean_T
...
) ) ; InverterModulesInSeries_RMS_Disable ( S , localDW ) ; } } } if (
...
InverterModulesInSeries_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , *
...
RMS_SubsysRanBC ) ; } } } void InverterModulesInSeries_RMS_Update ( SimStruct
* S , B_RMS_InverterModulesInSeries_T * localB ,
DW_RMS_InverterModulesInSeries_T * localDW , P_RMS_InverterModulesInSeries_T
* localP ) { int32_T isHit ; if ( localDW -> RMS_MODE ) { { real_T * *
uBuffer = ( real_T * * ) & localDW -> TransportDelay_PWORK . TUbufferPtrs [ 0
] ; real_T * * tBuffer = ( real_T * * ) & localDW -> TransportDelay_PWORK .
TUbufferPtrs [ 3 ] ; real_T simTime = ssGetT ( S ) ; localDW ->
TransportDelay_IWORK . Head [ 0 ] = ( ( localDW -> TransportDelay_IWORK .
Head [ 0 ] < ( localDW -> TransportDelay_IWORK . CircularBufSize [ 0 ] - 1 )
) ? ( localDW -> TransportDelay_IWORK . Head [ 0 ] + 1 ) : 0 ) ; if ( localDW
-> TransportDelay_IWORK . Head [ 0 ] == localDW -> TransportDelay_IWORK .
Tail [ 0 ] ) { if ( !
InverterModulesInSeries_acc_rt_TDelayUpdateTailOrGrowBuf ( & localDW ->
...
B_RMS_InverterModulesInSeries_T * localB , DW_RMS_InverterModulesInSeries_T *
localDW , XDot_RMS_InverterModulesInSeries_T * localXdot ) { if ( localDW ->
...
InverterModulesInSeries_RMS_Term ( SimStruct * const S ) { } void
...
X_TrueRMS_InverterModulesInSeries_T * localX ) { localX ->
...
DW_TrueRMS_InverterModulesInSeries_T * localDW ) { localDW -> TrueRMS_MODE =
false ; } void InverterModulesInSeries_TrueRMS ( SimStruct * S , boolean_T
rtu_Enable , real_T rtu_In , const real_T rtu_In_j [ 2 ] ,
B_TrueRMS_InverterModulesInSeries_T * localB ,
DW_TrueRMS_InverterModulesInSeries_T * localDW ,
P_TrueRMS_InverterModulesInSeries_T * localP ,
X_TrueRMS_InverterModulesInSeries_T * localX ,
XDis_TrueRMS_InverterModulesInSeries_T * localXdis ) { int32_T isHit ; isHit
= ssIsSampleHit ( S , 1 , 0 ) ; if ( ( isHit != 0 ) && ( ssIsMajorTimeStep (
S ) != 0 ) ) { if ( rtu_Enable ) { if ( ! localDW -> TrueRMS_MODE ) { if (
...
InverterModulesInSeries_TrueRMS_Disable ( S , localDW ) ; } } } if ( localDW
-> TrueRMS_MODE ) { localB -> B_24_1_0 [ 0 ] = localX -> integrator_CSTATE_cc
[ 0 ] ; localB -> B_24_1_0 [ 1 ] = localX -> integrator_CSTATE_cc [ 1 ] ;
localB -> B_24_1_0 [ 2 ] = localX -> integrator_CSTATE_cc [ 2 ] ; { real_T *
...
int_T i1 ; real_T * y0 = & localB -> B_24_2_0 [ 0 ] ; int_T * iw_Tail = &
localDW -> TransportDelay_IWORK . Tail [ 0 ] ; int_T * iw_Head = & localDW ->
...
; } } } } void InverterModulesInSeries_TrueRMS_Update ( SimStruct * S ,
B_TrueRMS_InverterModulesInSeries_T * localB ,
DW_TrueRMS_InverterModulesInSeries_T * localDW ,
P_TrueRMS_InverterModulesInSeries_T * localP ) { int32_T isHit ; if ( localDW
...
B_TrueRMS_InverterModulesInSeries_T * localB ,
DW_TrueRMS_InverterModulesInSeries_T * localDW ,
XDot_TrueRMS_InverterModulesInSeries_T * localXdot ) { if ( localDW ->
...
DW_TrueRMS_InverterModulesInSeries_T * localDW ,
P_TrueRMS_InverterModulesInSeries_T * localP ,
ZCV_TrueRMS_InverterModulesInSeries_T * localZCSV ) { if ( localDW ->
...
6 ; i ++ ) { zcsv [ i ] = 0.0 ; } } } } void
InverterModulesInSeries_TrueRMS_Term ( SimStruct * const S ) { } static void
mdlOutputs ( SimStruct * S , int_T tid ) { real_T B_33_256_0 ; real_T
...
B_InverterModulesInSeries_T * _rtB ; P_InverterModulesInSeries_T * _rtP ;
X_InverterModulesInSeries_T * _rtX ; DW_InverterModulesInSeries_T * _rtDW ;
_rtDW = ( ( DW_InverterModulesInSeries_T * ) ssGetRootDWork ( S ) ) ; _rtX =
( ( X_InverterModulesInSeries_T * ) ssGetContStates ( S ) ) ; _rtP = ( (
P_InverterModulesInSeries_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_InverterModulesInSeries_T * ) _ssGetModelBlockIO ( S ) ) ; isHit =
...
( _rtB -> B_33_18_0 > InverterModulesInSeries_rtC ( S ) -> B_33_19_0 ) ; } if
( _rtDW -> Compare_Mode ) { _rtB -> B_33_22_0 = _rtB -> B_33_7_0 ; } else {
_rtB -> B_33_22_0 = _rtB -> B_33_21_0 ; } } isHit = ssIsSampleHit ( S , 2 , 0
) ; if ( isHit != 0 ) { _rtB -> B_33_23_0 = _rtDW -> DelayInput2_DSTATE ; }
isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { rtb_B_33_24_0 =
_rtB -> B_33_22_0 - _rtB -> B_33_23_0 ; rtb_B_33_25_0 = ( rtb_B_33_24_0 >
_rtB -> B_33_6_0 ) ; } isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0
) { _rtB -> B_33_27_0 = _rtB -> B_33_26_0 * rtb_B_33_5_0 ; } isHit =
ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { if ( rtb_B_33_25_0 ) {
...
B_33_18_0 < InverterModulesInSeries_rtC ( S ) -> B_33_35_0 ) ; } if ( _rtDW
-> Compare_Mode_g ) { _rtB -> B_33_37_0 = _rtB -> B_33_7_0 ; } else { _rtB ->
B_33_37_0 = _rtB -> B_33_21_0 ; } } isHit = ssIsSampleHit ( S , 2 , 0 ) ; if
( isHit != 0 ) { _rtB -> B_33_38_0 = _rtDW -> DelayInput2_DSTATE_c ; } isHit
= ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { rtb_B_33_39_0 = _rtB ->
B_33_37_0 - _rtB -> B_33_38_0 ; rtb_B_33_40_0 = ( rtb_B_33_39_0 > _rtB ->
B_33_34_0 ) ; } isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) {
...
_rtDW -> Compare_Mode_p = ( _rtB -> B_33_51_0 > InverterModulesInSeries_rtC (
S ) -> B_33_52_0 ) ; } if ( _rtDW -> Compare_Mode_p ) { _rtB -> B_33_54_0 =
_rtB -> B_33_7_0 ; } else { _rtB -> B_33_54_0 = _rtB -> B_33_21_0 ; } } isHit
= ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) { _rtB -> B_33_55_0 = _rtDW
-> DelayInput2_DSTATE_d ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit
!= 0 ) { rtb_B_33_56_0 = _rtB -> B_33_54_0 - _rtB -> B_33_55_0 ;
rtb_B_33_57_0 = ( rtb_B_33_56_0 > _rtB -> B_33_49_0 ) ; } isHit =
ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) { _rtB -> B_33_59_0 = _rtB ->
B_33_58_0 * rtb_B_33_48_0 ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if (
isHit != 0 ) { if ( rtb_B_33_57_0 ) { rtb_B_33_56_0 = _rtB -> B_33_49_0 ; }
else { if ( rtb_B_33_56_0 < _rtB -> B_33_59_0 ) { rtb_B_33_56_0 = _rtB ->
B_33_59_0 ; } } _rtB -> B_33_62_0 = rtb_B_33_56_0 + _rtB -> B_33_55_0 ; }
isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) { _rtB -> B_33_63_0 [
0 ] = _rtB -> B_33_62_0 ; _rtB -> B_33_63_0 [ 1 ] = 0.0 ; _rtB -> B_33_63_0 [
2 ] = 0.0 ; _rtDW -> INPUT_3_1_1_discrete [ 0 ] = ! ( _rtB -> B_33_63_0 [ 0 ]
== _rtDW -> INPUT_3_1_1_discrete [ 1 ] ) ; _rtDW -> INPUT_3_1_1_discrete [ 1
] = _rtB -> B_33_63_0 [ 0 ] ; _rtB -> B_33_63_0 [ 0 ] = _rtDW ->
INPUT_3_1_1_discrete [ 1 ] ; _rtB -> B_33_63_0 [ 3 ] = _rtDW ->
INPUT_3_1_1_discrete [ 0 ] ; rtb_B_33_65_0 = _rtP -> P_60 ; _rtB -> B_33_66_0
= _rtB -> B_33_64_0 * _rtP -> P_60 ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ;
if ( isHit != 0 ) { if ( ssIsMajorTimeStep ( S ) != 0 ) { _rtDW ->
Compare_Mode_j = ( _rtB -> B_33_51_0 < InverterModulesInSeries_rtC ( S ) ->
B_33_67_0 ) ; } if ( _rtDW -> Compare_Mode_j ) { _rtB -> B_33_69_0 = _rtB ->
B_33_7_0 ; } else { _rtB -> B_33_69_0 = _rtB -> B_33_21_0 ; } } isHit =
ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) { _rtB -> B_33_70_0 = _rtDW
-> DelayInput2_DSTATE_f ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit
!= 0 ) { rtb_B_33_71_0 = _rtB -> B_33_69_0 - _rtB -> B_33_70_0 ;
rtb_B_33_72_0 = ( rtb_B_33_71_0 > _rtB -> B_33_66_0 ) ; } isHit =
ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) { _rtB -> B_33_74_0 = _rtB ->
B_33_73_0 * rtb_B_33_65_0 ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if (
isHit != 0 ) { if ( rtb_B_33_72_0 ) { rtb_B_33_71_0 = _rtB -> B_33_66_0 ; }
else { if ( rtb_B_33_71_0 < _rtB -> B_33_74_0 ) { rtb_B_33_71_0 = _rtB ->
B_33_74_0 ; } } _rtB -> B_33_77_0 = rtb_B_33_71_0 + _rtB -> B_33_70_0 ; }
isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) { _rtB -> B_33_78_0 [
0 ] = _rtB -> B_33_77_0 ; _rtB -> B_33_78_0 [ 1 ] = 0.0 ; _rtB -> B_33_78_0 [
2 ] = 0.0 ; _rtDW -> INPUT_4_1_1_discrete [ 0 ] = ! ( _rtB -> B_33_78_0 [ 0 ]
== _rtDW -> INPUT_4_1_1_discrete [ 1 ] ) ; _rtDW -> INPUT_4_1_1_discrete [ 1
] = _rtB -> B_33_78_0 [ 0 ] ; _rtB -> B_33_78_0 [ 0 ] = _rtDW ->
INPUT_4_1_1_discrete [ 1 ] ; _rtB -> B_33_78_0 [ 3 ] = _rtDW ->
INPUT_4_1_1_discrete [ 0 ] ; rtb_B_33_80_0 = _rtP -> P_65 ; _rtB -> B_33_81_0
= _rtB -> B_33_79_0 * _rtP -> P_65 ; } _rtB -> B_33_82_0 = muDoubleScalarSin
( _rtP -> P_68 * ssGetTaskTime ( S , 0 ) + _rtP -> P_69 ) * _rtP -> P_66 +
_rtP -> P_67 ; _rtB -> B_33_83_0 = _rtB -> B_33_82_0 - _rtB -> B_33_17_0 ;
isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { if (
ssIsMajorTimeStep ( S ) != 0 ) { _rtDW -> Compare_Mode_h = ( _rtB ->
B_33_83_0 > InverterModulesInSeries_rtC ( S ) -> B_33_84_0 ) ; } if ( _rtDW
...
B_33_83_0 < InverterModulesInSeries_rtC ( S ) -> B_33_99_0 ) ; } if ( _rtDW
-> Compare_Mode_i ) { _rtB -> B_33_101_0 = _rtB -> B_33_7_0 ; } else { _rtB
-> B_33_101_0 = _rtB -> B_33_21_0 ; } } isHit = ssIsSampleHit ( S , 2 , 0 ) ;
if ( isHit != 0 ) { _rtB -> B_33_102_0 = _rtDW -> DelayInput2_DSTATE_m ; }
isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { rtb_B_33_103_0 =
_rtB -> B_33_101_0 - _rtB -> B_33_102_0 ; rtb_B_33_104_0 = ( rtb_B_33_103_0 >
_rtB -> B_33_98_0 ) ; } isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0
) { _rtB -> B_33_106_0 = _rtB -> B_33_105_0 * rtb_B_33_97_0 ; } isHit =
...
-> B_33_125_0 > InverterModulesInSeries_rtC ( S ) -> B_33_126_0 ) ; } if (
_rtDW -> Compare_Mode_ja ) { _rtB -> B_33_129_0 = _rtB -> B_33_114_0 ; } else
{ _rtB -> B_33_129_0 = _rtB -> B_33_128_0 ; } } isHit = ssIsSampleHit ( S , 2
, 0 ) ; if ( isHit != 0 ) { _rtB -> B_33_130_0 = _rtDW ->
...
-> Compare_Mode_c = ( _rtB -> B_33_125_0 < InverterModulesInSeries_rtC ( S )
-> B_33_142_0 ) ; } if ( _rtDW -> Compare_Mode_c ) { _rtB -> B_33_144_0 =
...
B_33_158_0 > InverterModulesInSeries_rtC ( S ) -> B_33_159_0 ) ; } if ( _rtDW
-> Compare_Mode_l ) { _rtB -> B_33_161_0 = _rtB -> B_33_114_0 ; } else { _rtB
-> B_33_161_0 = _rtB -> B_33_128_0 ; } } isHit = ssIsSampleHit ( S , 2 , 0 )
; if ( isHit != 0 ) { _rtB -> B_33_162_0 = _rtDW -> DelayInput2_DSTATE_a ; }
isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { rtb_B_33_163_0 =
_rtB -> B_33_161_0 - _rtB -> B_33_162_0 ; rtb_B_33_164_0 = ( rtb_B_33_163_0 >
_rtB -> B_33_156_0 ) ; } isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit !=
0 ) { _rtB -> B_33_166_0 = _rtB -> B_33_165_0 * rtb_B_33_155_0 ; } isHit =
ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { if ( rtb_B_33_164_0 ) {
rtb_B_33_163_0 = _rtB -> B_33_156_0 ; } else { if ( rtb_B_33_163_0 < _rtB ->
B_33_166_0 ) { rtb_B_33_163_0 = _rtB -> B_33_166_0 ; } } _rtB -> B_33_169_0 =
rtb_B_33_163_0 + _rtB -> B_33_162_0 ; } isHit = ssIsSampleHit ( S , 2 , 0 ) ;
if ( isHit != 0 ) { _rtB -> B_33_170_0 [ 0 ] = _rtB -> B_33_169_0 ; _rtB ->
B_33_170_0 [ 1 ] = 0.0 ; _rtB -> B_33_170_0 [ 2 ] = 0.0 ; _rtDW ->
INPUT_9_1_1_discrete [ 0 ] = ! ( _rtB -> B_33_170_0 [ 0 ] == _rtDW ->
INPUT_9_1_1_discrete [ 1 ] ) ; _rtDW -> INPUT_9_1_1_discrete [ 1 ] = _rtB ->
B_33_170_0 [ 0 ] ; _rtB -> B_33_170_0 [ 0 ] = _rtDW -> INPUT_9_1_1_discrete [
1 ] ; _rtB -> B_33_170_0 [ 3 ] = _rtDW -> INPUT_9_1_1_discrete [ 0 ] ;
rtb_B_33_172_0 = _rtP -> P_110 ; _rtB -> B_33_173_0 = _rtB -> B_33_171_0 *
_rtP -> P_110 ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) {
if ( ssIsMajorTimeStep ( S ) != 0 ) { _rtDW -> Compare_Mode_o = ( _rtB ->
B_33_158_0 < InverterModulesInSeries_rtC ( S ) -> B_33_174_0 ) ; } if ( _rtDW
-> Compare_Mode_o ) { _rtB -> B_33_176_0 = _rtB -> B_33_114_0 ; } else { _rtB
-> B_33_176_0 = _rtB -> B_33_128_0 ; } } isHit = ssIsSampleHit ( S , 2 , 0 )
; if ( isHit != 0 ) { _rtB -> B_33_177_0 = _rtDW -> DelayInput2_DSTATE_nv ; }
isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { rtb_B_33_178_0 =
_rtB -> B_33_176_0 - _rtB -> B_33_177_0 ; rtb_B_33_179_0 = ( rtb_B_33_178_0 >
_rtB -> B_33_173_0 ) ; } isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit !=
0 ) { _rtB -> B_33_181_0 = _rtB -> B_33_180_0 * rtb_B_33_172_0 ; } isHit =
ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { if ( rtb_B_33_179_0 ) {
rtb_B_33_178_0 = _rtB -> B_33_173_0 ; } else { if ( rtb_B_33_178_0 < _rtB ->
B_33_181_0 ) { rtb_B_33_178_0 = _rtB -> B_33_181_0 ; } } _rtB -> B_33_184_0 =
rtb_B_33_178_0 + _rtB -> B_33_177_0 ; } isHit = ssIsSampleHit ( S , 2 , 0 ) ;
if ( isHit != 0 ) { _rtB -> B_33_185_0 [ 0 ] = _rtB -> B_33_184_0 ; _rtB ->
B_33_185_0 [ 1 ] = 0.0 ; _rtB -> B_33_185_0 [ 2 ] = 0.0 ; _rtDW ->
INPUT_10_1_1_discrete [ 0 ] = ! ( _rtB -> B_33_185_0 [ 0 ] == _rtDW ->
INPUT_10_1_1_discrete [ 1 ] ) ; _rtDW -> INPUT_10_1_1_discrete [ 1 ] = _rtB
-> B_33_185_0 [ 0 ] ; _rtB -> B_33_185_0 [ 0 ] = _rtDW ->
INPUT_10_1_1_discrete [ 1 ] ; _rtB -> B_33_185_0 [ 3 ] = _rtDW ->
...
B_33_190_0 > InverterModulesInSeries_rtC ( S ) -> B_33_191_0 ) ; } if ( _rtDW
-> Compare_Mode_hj ) { _rtB -> B_33_193_0 = _rtB -> B_33_114_0 ; } else {
_rtB -> B_33_193_0 = _rtB -> B_33_128_0 ; } } isHit = ssIsSampleHit ( S , 2 ,
0 ) ; if ( isHit != 0 ) { _rtB -> B_33_194_0 = _rtDW -> DelayInput2_DSTATE_o
; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { rtb_B_33_195_0
= _rtB -> B_33_193_0 - _rtB -> B_33_194_0 ; rtb_B_33_196_0 = ( rtb_B_33_195_0
> _rtB -> B_33_188_0 ) ; } isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit
!= 0 ) { _rtB -> B_33_198_0 = _rtB -> B_33_197_0 * rtb_B_33_187_0 ; } isHit =
ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { if ( rtb_B_33_196_0 ) {
rtb_B_33_195_0 = _rtB -> B_33_188_0 ; } else { if ( rtb_B_33_195_0 < _rtB ->
B_33_198_0 ) { rtb_B_33_195_0 = _rtB -> B_33_198_0 ; } } _rtB -> B_33_201_0 =
rtb_B_33_195_0 + _rtB -> B_33_194_0 ; } isHit = ssIsSampleHit ( S , 2 , 0 ) ;
if ( isHit != 0 ) { _rtB -> B_33_202_0 [ 0 ] = _rtB -> B_33_201_0 ; _rtB ->
B_33_202_0 [ 1 ] = 0.0 ; _rtB -> B_33_202_0 [ 2 ] = 0.0 ; _rtDW ->
INPUT_11_1_1_discrete [ 0 ] = ! ( _rtB -> B_33_202_0 [ 0 ] == _rtDW ->
INPUT_11_1_1_discrete [ 1 ] ) ; _rtDW -> INPUT_11_1_1_discrete [ 1 ] = _rtB
-> B_33_202_0 [ 0 ] ; _rtB -> B_33_202_0 [ 0 ] = _rtDW ->
INPUT_11_1_1_discrete [ 1 ] ; _rtB -> B_33_202_0 [ 3 ] = _rtDW ->
INPUT_11_1_1_discrete [ 0 ] ; rtb_B_33_204_0 = _rtP -> P_124 ; _rtB ->
B_33_205_0 = _rtB -> B_33_203_0 * _rtP -> P_124 ; } isHit = ssIsSampleHit ( S
, 1 , 0 ) ; if ( isHit != 0 ) { if ( ssIsMajorTimeStep ( S ) != 0 ) { _rtDW
-> Compare_Mode_i4 = ( _rtB -> B_33_190_0 < InverterModulesInSeries_rtC ( S )
-> B_33_206_0 ) ; } if ( _rtDW -> Compare_Mode_i4 ) { _rtB -> B_33_208_0 =
_rtB -> B_33_114_0 ; } else { _rtB -> B_33_208_0 = _rtB -> B_33_128_0 ; } }
isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) { _rtB -> B_33_209_0
= _rtDW -> DelayInput2_DSTATE_k ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if
( isHit != 0 ) { rtb_B_33_210_0 = _rtB -> B_33_208_0 - _rtB -> B_33_209_0 ;
rtb_B_33_211_0 = ( rtb_B_33_210_0 > _rtB -> B_33_205_0 ) ; } isHit =
ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) { _rtB -> B_33_213_0 = _rtB
-> B_33_212_0 * rtb_B_33_204_0 ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if (
isHit != 0 ) { if ( rtb_B_33_211_0 ) { rtb_B_33_210_0 = _rtB -> B_33_205_0 ;
} else { if ( rtb_B_33_210_0 < _rtB -> B_33_213_0 ) { rtb_B_33_210_0 = _rtB
-> B_33_213_0 ; } } _rtB -> B_33_216_0 = rtb_B_33_210_0 + _rtB -> B_33_209_0
; } isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) { _rtB ->
B_33_217_0 [ 0 ] = _rtB -> B_33_216_0 ; _rtB -> B_33_217_0 [ 1 ] = 0.0 ; _rtB
-> B_33_217_0 [ 2 ] = 0.0 ; _rtDW -> INPUT_12_1_1_discrete [ 0 ] = ! ( _rtB
-> B_33_217_0 [ 0 ] == _rtDW -> INPUT_12_1_1_discrete [ 1 ] ) ; _rtDW ->
INPUT_12_1_1_discrete [ 1 ] = _rtB -> B_33_217_0 [ 0 ] ; _rtB -> B_33_217_0 [
0 ] = _rtDW -> INPUT_12_1_1_discrete [ 1 ] ; _rtB -> B_33_217_0 [ 3 ] = _rtDW
-> INPUT_12_1_1_discrete [ 0 ] ; ssCallAccelRunBlock ( S , 33 , 218 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 33 , 219 ,
...
InverterModulesInSeries_TrueRMS ( S , _rtB -> B_33_233_0 , _rtB -> B_33_219_0
[ 29 ] , & _rtB -> B_33_219_0 [ 27 ] , & _rtB -> TrueRMS_o , & _rtDW ->
TrueRMS_o , & _rtP -> TrueRMS_o , & _rtX -> TrueRMS_o , & ( (
XDis_InverterModulesInSeries_T * ) ssGetContStateDisabled ( S ) ) ->
TrueRMS_o ) ; InverterModulesInSeries_RMS ( S , _rtB -> B_33_235_0 , _rtB ->
B_33_219_0 [ 29 ] , & _rtB -> B_33_219_0 [ 27 ] , & _rtB -> RMS_m , & _rtDW
-> RMS_m , & _rtP -> RMS_m , & _rtX -> RMS_m , & ( (
XDis_InverterModulesInSeries_T * ) ssGetContStateDisabled ( S ) ) -> RMS_m )
; if ( _rtB -> B_33_233_0 ) { _rtB -> B_33_237_0 [ 0 ] = _rtB -> TrueRMS_o .
B_24_10_0 [ 0 ] ; _rtB -> B_33_237_0 [ 1 ] = _rtB -> TrueRMS_o . B_24_10_0 [
1 ] ; _rtB -> B_33_237_0 [ 2 ] = _rtB -> TrueRMS_o . B_24_10_0 [ 2 ] ; } else
{ _rtB -> B_33_237_0 [ 0 ] = _rtB -> RMS_m . B_22_22_0 [ 0 ] ; _rtB ->
B_33_237_0 [ 1 ] = _rtB -> RMS_m . B_22_22_0 [ 1 ] ; _rtB -> B_33_237_0 [ 2 ]
= _rtB -> RMS_m . B_22_22_0 [ 2 ] ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ;
if ( isHit != 0 ) { { if ( ( _rtDW ->
...
InverterModulesInSeries_TrueRMS ( S , _rtB -> B_33_240_0 , _rtB -> B_33_219_0
[ 3 ] , & _rtB -> B_33_219_0 [ 1 ] , & _rtB -> TrueRMS , & _rtDW -> TrueRMS ,
& _rtP -> TrueRMS , & _rtX -> TrueRMS , & ( ( XDis_InverterModulesInSeries_T
* ) ssGetContStateDisabled ( S ) ) -> TrueRMS ) ; InverterModulesInSeries_RMS
( S , _rtB -> B_33_242_0 , _rtB -> B_33_219_0 [ 3 ] , & _rtB -> B_33_219_0 [
1 ] , & _rtB -> RMS , & _rtDW -> RMS , & _rtP -> RMS , & _rtX -> RMS , & ( (
XDis_InverterModulesInSeries_T * ) ssGetContStateDisabled ( S ) ) -> RMS ) ;
...
B_33_256_0 = InverterModulesInSeries_acc_rt_TDelayInterpolate ( tMinusDelay ,
0.0 , * tBuffer , * uBuffer , _rtDW -> TransportDelay_IWORK . CircularBufSize
, & _rtDW -> TransportDelay_IWORK . Last , _rtDW -> TransportDelay_IWORK .
Tail , _rtDW -> TransportDelay_IWORK . Head , _rtP -> P_153 , 0 , ( boolean_T
) ( ssIsMinorTimeStep ( S ) && ( ssGetTimeOfLastOutput ( S ) == ssGetT ( S )
) ) ) ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { _rtB ->
B_33_258_0 = _rtP -> P_154 ; } rtb_B_33_25_0 = ( ssGetT ( S ) >= _rtB ->
B_33_258_0 ) ; isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { _rtB
-> B_33_260_0 = _rtDW -> Memory_PreviousInput ; } if ( rtb_B_33_25_0 ) { _rtB
-> B_33_262_0 = ( _rtB -> B_33_255_0 - B_33_256_0 ) * _rtP -> P_1 ; } else {
_rtB -> B_33_262_0 = _rtB -> B_33_260_0 ; } _rtB -> B_33_263_0 = _rtX ->
...
ssGetT ( S ) ; real_T tMinusDelay = simTime - _rtP -> P_157 ; B_33_264_0 =
InverterModulesInSeries_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , *
...
P_162 ; B_33_274_0 = InverterModulesInSeries_acc_rt_TDelayInterpolate (
...
P_172 ; B_33_293_0 = InverterModulesInSeries_acc_rt_TDelayInterpolate (
...
P_187 ; B_33_319_0 = InverterModulesInSeries_acc_rt_TDelayInterpolate (
...
int_T tid ) { B_InverterModulesInSeries_T * _rtB ;
P_InverterModulesInSeries_T * _rtP ; _rtP = ( ( P_InverterModulesInSeries_T *
) ssGetModelRtp ( S ) ) ; _rtB = ( ( B_InverterModulesInSeries_T * )
_ssGetModelBlockIO ( S ) ) ; _rtB -> B_33_4_0 = _rtP -> P_28 ; _rtB ->
B_33_7_0 = _rtP -> P_30 ; _rtB -> B_33_21_0 = _rtP -> P_42 ; _rtB ->
B_33_26_0 = _rtP -> P_44 ; _rtB -> B_33_32_0 = _rtP -> P_45 ; _rtB ->
B_33_41_0 = _rtP -> P_49 ; _rtB -> B_33_47_0 = _rtP -> P_50 ; _rtB ->
B_33_58_0 = _rtP -> P_58 ; _rtB -> B_33_64_0 = _rtP -> P_59 ; _rtB ->
...
B_InverterModulesInSeries_T * _rtB ; P_InverterModulesInSeries_T * _rtP ;
DW_InverterModulesInSeries_T * _rtDW ; _rtDW = ( (
DW_InverterModulesInSeries_T * ) ssGetRootDWork ( S ) ) ; _rtP = ( (
P_InverterModulesInSeries_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_InverterModulesInSeries_T * ) _ssGetModelBlockIO ( S ) ) ; isHit =
...
218 , SS_CALL_MDL_UPDATE ) ; } InverterModulesInSeries_TrueRMS_Update ( S , &
_rtB -> TrueRMS_o , & _rtDW -> TrueRMS_o , & _rtP -> TrueRMS_o ) ;
InverterModulesInSeries_RMS_Update ( S , & _rtB -> RMS_m , & _rtDW -> RMS_m ,
& _rtP -> RMS_m ) ; InverterModulesInSeries_TrueRMS_Update ( S , & _rtB ->
TrueRMS , & _rtDW -> TrueRMS , & _rtP -> TrueRMS ) ;
InverterModulesInSeries_RMS_Update ( S , & _rtB -> RMS , & _rtDW -> RMS , &
...
. Tail ) { if ( ! InverterModulesInSeries_acc_rt_TDelayUpdateTailOrGrowBuf (
& _rtDW -> TransportDelay_IWORK . CircularBufSize , & _rtDW ->
TransportDelay_IWORK . Tail , & _rtDW -> TransportDelay_IWORK . Head , &
_rtDW -> TransportDelay_IWORK . Last , simTime - _rtP -> P_152 , tBuffer ,
...
TransportDelay_IWORK . Head ] = _rtB -> B_33_255_0 ; } isHit = ssIsSampleHit
( S , 1 , 0 ) ; if ( isHit != 0 ) { _rtDW -> Memory_PreviousInput = _rtB ->
B_33_262_0 ; } { real_T * * uBuffer = ( real_T * * ) & _rtDW ->
TransportDelay_PWORK_i . TUbufferPtrs [ 0 ] ; real_T * * tBuffer = ( real_T *
* ) & _rtDW -> TransportDelay_PWORK_i . TUbufferPtrs [ 1 ] ; real_T simTime =
ssGetT ( S ) ; _rtDW -> TransportDelay_IWORK_c . Head = ( ( _rtDW ->
...
InverterModulesInSeries_acc_rt_TDelayUpdateTailOrGrowBuf ( & _rtDW ->
TransportDelay_IWORK_c . CircularBufSize , & _rtDW -> TransportDelay_IWORK_c
. Tail , & _rtDW -> TransportDelay_IWORK_c . Head , & _rtDW ->
TransportDelay_IWORK_c . Last , simTime - _rtP -> P_157 , tBuffer , uBuffer ,
...
B_33_263_0 ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) {
_rtDW -> Memory_PreviousInput_e = _rtB -> B_33_270_0 ; } { real_T * * uBuffer
...
if ( ! InverterModulesInSeries_acc_rt_TDelayUpdateTailOrGrowBuf ( & _rtDW ->
TransportDelay_IWORK_m . CircularBufSize , & _rtDW -> TransportDelay_IWORK_m
. Tail , & _rtDW -> TransportDelay_IWORK_m . Head , & _rtDW ->
TransportDelay_IWORK_m . Last , simTime - _rtP -> P_162 , tBuffer , uBuffer ,
...
B_33_273_0 ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) {
_rtDW -> Memory_PreviousInput_k = _rtB -> B_33_280_0 ; } { real_T * * uBuffer
...
TransportDelay_IWORK_d . Last , simTime - _rtP -> P_167 , tBuffer , uBuffer ,
...
B_33_281_0 ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) {
_rtDW -> Memory_PreviousInput_h = _rtB -> B_33_288_0 ; } { real_T * * uBuffer
...
TransportDelay_IWORK_e . Last , simTime - _rtP -> P_172 , tBuffer , uBuffer ,
...
B_33_292_0 ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) {
_rtDW -> Memory_PreviousInput_a = _rtB -> B_33_299_0 ; } { real_T * * uBuffer
...
TransportDelay_IWORK_p . Last , simTime - _rtP -> P_177 , tBuffer , uBuffer ,
...
B_33_300_0 ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) {
_rtDW -> Memory_PreviousInput_c = _rtB -> B_33_307_0 ; } { real_T * * uBuffer
= ( real_T * * ) & _rtDW -> TransportDelay_PWORK_jk . TUbufferPtrs [ 0 ] ;
real_T * * tBuffer = ( real_T * * ) & _rtDW -> TransportDelay_PWORK_jk .
TUbufferPtrs [ 1 ] ; real_T simTime = ssGetT ( S ) ; _rtDW ->
...
TransportDelay_IWORK_l . Last , simTime - _rtP -> P_182 , tBuffer , uBuffer ,
...
B_33_310_0 ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) {
_rtDW -> Memory_PreviousInput_f = _rtB -> B_33_317_0 ; } { real_T * * uBuffer
...
TransportDelay_IWORK_o . Last , simTime - _rtP -> P_187 , tBuffer , uBuffer ,
...
B_33_318_0 ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) {
_rtDW -> Memory_PreviousInput_eh = _rtB -> B_33_325_0 ; } if ( _rtDW ->
TrueRMS_MODE ) { { real_T * * uBuffer = ( real_T * * ) & _rtDW ->
TransportDelay_PWORK_oj . TUbufferPtrs [ 0 ] ; real_T * * tBuffer = ( real_T
* * ) & _rtDW -> TransportDelay_PWORK_oj . TUbufferPtrs [ 1 ] ; real_T
simTime = ssGetT ( S ) ; _rtDW -> TransportDelay_IWORK_dv . Head = ( ( _rtDW
...
static void mdlDerivatives ( SimStruct * S ) { B_InverterModulesInSeries_T *
_rtB ; XDot_InverterModulesInSeries_T * _rtXdot ;
DW_InverterModulesInSeries_T * _rtDW ; _rtDW = ( (
DW_InverterModulesInSeries_T * ) ssGetRootDWork ( S ) ) ; _rtXdot = ( (
XDot_InverterModulesInSeries_T * ) ssGetdX ( S ) ) ; _rtB = ( (
B_InverterModulesInSeries_T * ) _ssGetModelBlockIO ( S ) ) ;
InverterModulesInSeries_TrueRMS_Deriv ( S , & _rtB -> TrueRMS_o , & _rtDW ->
TrueRMS_o , & _rtXdot -> TrueRMS_o ) ; InverterModulesInSeries_RMS_Deriv ( S
, & _rtB -> RMS_m , & _rtDW -> RMS_m , & _rtXdot -> RMS_m ) ;
InverterModulesInSeries_TrueRMS_Deriv ( S , & _rtB -> TrueRMS , & _rtDW ->
TrueRMS , & _rtXdot -> TrueRMS ) ; InverterModulesInSeries_RMS_Deriv ( S , &
_rtB -> RMS , & _rtDW -> RMS , & _rtXdot -> RMS ) ; _rtXdot ->
integrator_CSTATE = _rtB -> B_33_331_0 ; _rtXdot -> integrator_CSTATE_c =
_rtB -> B_33_333_0 ; _rtXdot -> integrator_CSTATE_l = _rtB -> B_33_335_0 ;
_rtXdot -> integrator_CSTATE_a = _rtB -> B_33_337_0 ; _rtXdot ->
integrator_CSTATE_o = _rtB -> B_33_339_0 ; _rtXdot -> integrator_CSTATE_h =
_rtB -> B_33_341_0 ; _rtXdot -> integrator_CSTATE_oe = _rtB -> B_33_343_0 ;
_rtXdot -> integrator_CSTATE_f = _rtB -> B_33_345_0 ; if ( _rtDW -> RMS_MODE
) { _rtXdot -> integrator_CSTATE_e = _rtB -> B_25_5_0 ; _rtXdot ->
integrator_CSTATE_i = _rtB -> B_25_3_0 ; } else { { real_T * dx ; int_T i ;
dx = & ( ( ( XDot_InverterModulesInSeries_T * ) ssGetdX ( S ) ) ->
integrator_CSTATE_e ) ; for ( i = 0 ; i < 2 ; i ++ ) { dx [ i ] = 0.0 ; } } }
if ( _rtDW -> TrueRMS_MODE ) { _rtXdot -> integrator_CSTATE_m = _rtB ->
B_27_8_0 ; } else { ( ( XDot_InverterModulesInSeries_T * ) ssGetdX ( S ) ) ->
integrator_CSTATE_m = 0.0 ; } }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { B_InverterModulesInSeries_T
* _rtB ; P_InverterModulesInSeries_T * _rtP ; ZCV_InverterModulesInSeries_T *
_rtZCSV ; DW_InverterModulesInSeries_T * _rtDW ; _rtDW = ( (
DW_InverterModulesInSeries_T * ) ssGetRootDWork ( S ) ) ; _rtZCSV = ( (
ZCV_InverterModulesInSeries_T * ) ssGetSolverZcSignalVector ( S ) ) ; _rtP =
( ( P_InverterModulesInSeries_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_InverterModulesInSeries_T * ) _ssGetModelBlockIO ( S ) ) ; _rtZCSV ->
Compare_RelopInput_ZC = _rtB -> B_33_18_0 - InverterModulesInSeries_rtC ( S )
-> B_33_19_0 ; _rtZCSV -> Compare_RelopInput_ZC_e = _rtB -> B_33_18_0 -
InverterModulesInSeries_rtC ( S ) -> B_33_35_0 ; _rtZCSV ->
Compare_RelopInput_ZC_p = _rtB -> B_33_51_0 - InverterModulesInSeries_rtC ( S
) -> B_33_52_0 ; _rtZCSV -> Compare_RelopInput_ZC_a = _rtB -> B_33_51_0 -
InverterModulesInSeries_rtC ( S ) -> B_33_67_0 ; _rtZCSV ->
Compare_RelopInput_ZC_n = _rtB -> B_33_83_0 - InverterModulesInSeries_rtC ( S
) -> B_33_84_0 ; _rtZCSV -> Compare_RelopInput_ZC_j = _rtB -> B_33_83_0 -
InverterModulesInSeries_rtC ( S ) -> B_33_99_0 ; _rtZCSV ->
Compare_RelopInput_ZC_o = _rtB -> B_33_125_0 - InverterModulesInSeries_rtC (
S ) -> B_33_126_0 ; _rtZCSV -> Compare_RelopInput_ZC_i = _rtB -> B_33_125_0 -
InverterModulesInSeries_rtC ( S ) -> B_33_142_0 ; _rtZCSV ->
Compare_RelopInput_ZC_f = _rtB -> B_33_158_0 - InverterModulesInSeries_rtC (
S ) -> B_33_159_0 ; _rtZCSV -> Compare_RelopInput_ZC_pd = _rtB -> B_33_158_0
- InverterModulesInSeries_rtC ( S ) -> B_33_174_0 ; _rtZCSV ->
Compare_RelopInput_ZC_d = _rtB -> B_33_190_0 - InverterModulesInSeries_rtC (
S ) -> B_33_191_0 ; _rtZCSV -> Compare_RelopInput_ZC_aj = _rtB -> B_33_190_0
- InverterModulesInSeries_rtC ( S ) -> B_33_206_0 ;
InverterModulesInSeries_TrueRMS_ZC ( S , & _rtB -> TrueRMS_o , & _rtDW ->
TrueRMS_o , & _rtP -> TrueRMS_o , & _rtZCSV -> TrueRMS_o ) ;
InverterModulesInSeries_TrueRMS_ZC ( S , & _rtB -> TrueRMS , & _rtDW ->
...
} else { { real_T * zcsv = & ( ( ( ZCV_InverterModulesInSeries_T * )
...
DW_InverterModulesInSeries_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal DWork sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofGlobalBlockIO ( S
) != sizeof ( B_InverterModulesInSeries_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal BlockIO sizes do "
"not match for accelerator mex file." ) ; } { int ssSizeofParams ;
ssGetSizeofParams ( S , & ssSizeofParams ) ; if ( ssSizeofParams != sizeof (
P_InverterModulesInSeries_T ) ) { static char msg [ 256 ] ; sprintf ( msg ,
"Unexpected error: Internal Parameters sizes do "
"not match for accelerator mex file." ) ; } } _ssSetModelRtp ( S , ( real_T *
) & InverterModulesInSeries_rtDefaultP ) ; _ssSetConstBlockIO ( S , &
InverterModulesInSeries_rtInvariant ) ; rt_InitInfAndNaN ( sizeof ( real_T )
) ; ( ( P_InverterModulesInSeries_T * ) ssGetModelRtp ( S ) ) -> P_26 = rtInf
; ( ( P_InverterModulesInSeries_T * ) ssGetModelRtp ( S ) ) -> TrueRMS_o .
P_7 = rtInf ; ( ( P_InverterModulesInSeries_T * ) ssGetModelRtp ( S ) ) ->
TrueRMS . P_7 = rtInf ; } static void mdlInitializeSampleTimes ( SimStruct *
S ) { slAccRegPrmChangeFcn ( S , mdlOutputsTID4 ) ; } static void
