...
typedef struct { creal_T B_17_16_0 ; real_T B_20_0_0 ; real_T B_20_2_0 ;
...
B_20_214_0 [ 192 ] ; real_T B_20_215_0 [ 53 ] ; real_T B_20_221_0 ; real_T
B_20_223_0 ; real_T B_20_224_0 ; real_T B_20_225_0 ; real_T B_20_226_0 ;
real_T B_20_227_0 ; real_T B_20_228_0 ; real_T B_20_231_0 ; real_T B_20_232_0
; real_T B_19_1_0 ; real_T B_19_2_0 ; real_T B_19_3_0 ; real_T B_19_4_0 ;
real_T B_19_7_0 ; real_T B_19_8_0 ; real_T B_19_9_0 ; real_T B_19_10_0 ;
real_T B_18_0_0 ; real_T B_18_1_0 ; real_T B_17_0_0 ; real_T B_17_1_0 ;
real_T B_17_3_0 ; real_T B_17_5_0 ; real_T B_17_7_0 ; real_T B_17_8_0 ;
real_T B_17_9_0 ; real_T B_17_11_0 ; real_T B_17_13_0 ; real_T B_17_15_0 ;
real_T B_17_19_0 ; real_T B_17_21_0 ; real_T B_17_22_0 ; real_T B_16_0_0 ;
real_T B_16_1_0 ; real_T B_15_0_0 ; real_T B_15_1_0 ; real_T B_14_1_0 [ 3 ] ;
real_T B_14_2_0 [ 3 ] ; real_T B_14_3_0 ; real_T B_14_4_0 [ 3 ] ; real_T
B_14_7_0 [ 3 ] ; real_T B_14_8_0 [ 3 ] ; real_T B_13_0_0 [ 3 ] ; real_T
B_13_1_0 [ 3 ] ; real_T B_12_3_0 [ 3 ] ; real_T B_12_5_0 [ 3 ] ; boolean_T
B_20_217_0 ; boolean_T B_20_219_0 ; boolean_T B_20_639_0 ; boolean_T
B_20_640_0 ; char_T pad_B_20_640_0 [ 4 ] ; } B_InverterModulesInSeries_T ;
typedef struct { real_T DelayInput2_DSTATE ; real_T INPUT_1_1_1_discrete [ 2
] ; real_T DelayInput2_DSTATE_c ; real_T INPUT_2_1_1_discrete [ 2 ] ; real_T
DelayInput2_DSTATE_o ; real_T INPUT_11_1_1_discrete [ 2 ] ; real_T
DelayInput2_DSTATE_k ; real_T INPUT_12_1_1_discrete [ 2 ] ; real_T
DelayInput2_DSTATE_d ; real_T INPUT_3_1_1_discrete [ 2 ] ; real_T
...
STATE_1_DiscStates [ 180 ] ; real_T Memory_PreviousInput ; real_T
Memory_PreviousInput_j ; real_T Memory_PreviousInput_n ; real_T
Memory_PreviousInput_k [ 3 ] ; struct { real_T modelTStart ; }
TransportDelay_RWORK ; struct { real_T modelTStart ; } TransportDelay_RWORK_d
; struct { real_T modelTStart ; } TransportDelay_RWORK_db ; struct { real_T
modelTStart ; } TransportDelay_RWORK_f ; void * STATE_1_Simulator ; void *
...
HiddenToAsyncQueue_InsertedFor_RMS1_at_outport_0_PWORK ; void * Scope_PWORK [
...
2 ] ; } TransportDelay_PWORK_o ; struct { void * TUbufferPtrs [ 2 ] ; }
TransportDelay_PWORK_g ; struct { void * TUbufferPtrs [ 6 ] ; }
...
TmpAtomicSubsysAtSwitchInport1_sysIdxToRun_d ; int32_T TrueRMS_sysIdxToRun_c
; int32_T TmpAtomicSubsysAtSwitchInport1_sysIdxToRun_db ; int32_T
RMS_sysIdxToRun_a ; int32_T TmpAtomicSubsysAtSwitch2Inport3_sysIdxToRun ;
...
CircularBufSize ; int_T MaxNewBufSize ; } TransportDelay_IWORK_e ; struct {
int_T Tail ; int_T Head ; int_T Last ; int_T CircularBufSize ; int_T
MaxNewBufSize ; } TransportDelay_IWORK_p ; struct { int_T Tail [ 3 ] ; int_T
Head [ 3 ] ; int_T Last [ 3 ] ; int_T CircularBufSize [ 3 ] ; int_T
MaxNewBufSize ; } TransportDelay_IWORK_g ; int_T
Saturationtoavoidnegativesqrt_MODE ; int_T
Saturationtoavoidnegativesqrt_MODE_c [ 3 ] ; int8_T TrueRMS_SubsysRanBC ;
int8_T Sqrt_DWORK1 ; int8_T RMS_SubsysRanBC ; int8_T TrueRMS_SubsysRanBC_i ;
...
] ; } DW_InverterModulesInSeries_T ; typedef struct { real_T
integrator_CSTATE ; real_T integrator_CSTATE_i ; real_T integrator_CSTATE_e ;
real_T integrator_CSTATE_c [ 3 ] ; real_T integrator_CSTATE_a [ 3 ] ; real_T
integrator_CSTATE_o [ 3 ] ; } X_InverterModulesInSeries_T ; typedef struct {
real_T integrator_CSTATE ; real_T integrator_CSTATE_i ; real_T
integrator_CSTATE_e ; real_T integrator_CSTATE_c [ 3 ] ; real_T
integrator_CSTATE_a [ 3 ] ; real_T integrator_CSTATE_o [ 3 ] ; }
XDot_InverterModulesInSeries_T ; typedef struct { boolean_T integrator_CSTATE
; boolean_T integrator_CSTATE_i ; boolean_T integrator_CSTATE_e ; boolean_T
integrator_CSTATE_c [ 3 ] ; boolean_T integrator_CSTATE_a [ 3 ] ; boolean_T
integrator_CSTATE_o [ 3 ] ; } XDis_InverterModulesInSeries_T ; typedef struct
{ real_T integrator_CSTATE ; real_T integrator_CSTATE_i ; real_T
integrator_CSTATE_e ; real_T integrator_CSTATE_c [ 3 ] ; real_T
integrator_CSTATE_a [ 3 ] ; real_T integrator_CSTATE_o [ 3 ] ; }
CStateAbsTol_InverterModulesInSeries_T ; typedef struct { real_T
Compare_RelopInput_ZC ; real_T Compare_RelopInput_ZC_e ; real_T
Compare_RelopInput_ZC_d ; real_T Compare_RelopInput_ZC_a ; real_T
Compare_RelopInput_ZC_p ; real_T Compare_RelopInput_ZC_av ; real_T
...
Saturationtoavoidnegativesqrt_LwrLim_ZC ; real_T
...
PrevZCX_InverterModulesInSeries_T ; typedef struct { const real_T B_20_15_0 ;
...
struct P_InverterModulesInSeries_T_ { real_T P_0 ; real_T P_1 ; real_T P_2 ;
