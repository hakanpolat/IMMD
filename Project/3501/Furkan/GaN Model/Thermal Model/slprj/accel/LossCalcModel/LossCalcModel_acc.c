...
( S , 0 , 3927367496U ) ; ssSetChecksumVal ( S , 1 , 3047392001U ) ;
ssSetChecksumVal ( S , 2 , 946632566U ) ; ssSetChecksumVal ( S , 3 ,
1948449881U ) ; { mxArray * slVerStructMat = NULL ; mxArray * slStrMat =
