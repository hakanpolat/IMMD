...
\title{design of an integrated modular motor drive (immd) for traction applications}
\turkishtitle{çekiş sistemleri için bir tümleşik modüler motor sürücü (TMMS) sistemi geliştirilmesi}
...
\committeememberi[prof]{Muammer Ermiş}
\affiliationi{Department of Electrical and Electronics Engineering, METU}
% Second committee member is always your supervisor
\committeememberii[prof]{Ozan Keysan}
\affiliationii{Department of Electrical and Electronics Engineering, METU}
...
\committeememberiii[prof]{Işık Çadırcı}
