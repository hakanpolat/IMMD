\textit{\documentclass[conference,a4paper,twocolumn]{IEEEtran}
\usepackage{graphicx}
\graphicspath{{images/}}
...
The conventional connection and the proposed connection are shown in Fig. \ref{fig:prop_conn} and Fig. \ref{fig:deneme}.
...
%\centerline{\subfloat[Case I]\includegraphics[width=8cm]{images/conv_conn}
%\label{fig:deneme}}
%\hfil
%\subfloat[Case II]{\includegraphics[width=8cm]{images/prop_conn}
%\label{fig:deneme}}
%\caption{Simulation results}
%\label{fig:deneme}
%\end{figure*}
