...
\begin{figure}[] 
\centering
\subfigure[]{\includegraphics[width=2.5in]{conv_conn}\label{conv_conn}} \hfil 
\subfigure[]{\includegraphics[width=2.5in]{prop_conn}\label{prop_conn}}
...
The rectifier output current ($i_{dc}$), the inverter input current ($i_{inv}$), and DC link capacitor current ($i_{c}$) are shown in Fig. \ref{fig:sample1}. \todo[inline]{Elde edilecek}. The DC link capacitor current is shown in Fig. \ref{fig:sample2} with and without the method, with 0.2 mF capacitance value. \todo[inline]{Elde edilecek}. The same figure is shown in Fig. \ref{fig:sample3} with 3 mF capacitance value. \todo[inline]{Elde edilecek}. 
