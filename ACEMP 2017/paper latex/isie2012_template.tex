...
Diode bridge rectifier is a natural-commutated converter, circuit schematic of which is shown in Fig. \ref{fig:rect_circuit}. A second order LC filter which is low-pass type is usually utilized at the rectifier output for filtering.
...
The supply voltages are shown in \ref{eq:1}-\ref{eq:3}, where $V_m$ is the RMS value of the supply voltage and $f_s$ is the supply frequency.
...
The transfer function of the DC link filter is shown in \ref{eq:5}. 
